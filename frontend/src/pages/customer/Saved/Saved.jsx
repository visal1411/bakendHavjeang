...
import { useSavedMechanics } from '@/pages/customer/Home/hooks/useSavedMechanics';

const Saved = () => {
  const { savedMechanics: mechanics, removeSavedMechanic } = useSavedMechanics();
